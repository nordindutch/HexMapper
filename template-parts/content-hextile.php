<div data-terrain="<?php echo get_sub_field('terrain')['value']; ?>" class="hex-top <?php if(get_sub_field('hidden') && !is_user_logged_in(  )){echo "hidden";} ?> <?php if(get_sub_field('terrain')['value'] == 'void'){echo "void";} ?>" 
